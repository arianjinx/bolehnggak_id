    ...
    <div className="container mx-auto px-6 lg:px-10 py-4 pt-10 text-sm">
      ...
      <div>
        <ul className="list-disc mb-6">
          ...
          <li>
            The authors of this site do not represent any organisation, nor are
            we doing this on behalf of any organisation.
          </li>
          <li>
            Any information posted is to the best of our knowledge and not
            intended to defame.
          </li>
          <li>We are not responsible for comments posted by other readers.</li>
          <li>
